# Script, en paradigma orientado a objetos pensado para comparar 
...
class Funcion_booleana:

    def __init__(self, quantity_of_variables):
        self.quantity_of_variables=quantity_of_variables
